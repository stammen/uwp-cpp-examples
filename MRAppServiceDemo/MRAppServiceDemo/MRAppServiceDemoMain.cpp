#include "pch.h"
#include "MRAppServiceDemoMain.h"
    ...
    m_locatabilityChangedToken =
        m_locator->LocatabilityChanged +=
            ref new Windows::Foundation::TypedEventHandler<SpatialLocator^, Object^>(
                std::bind(&MRAppServiceDemoMain::OnLocatabilityChanged, this, _1, _2)
                );
    ...
    m_cameraAddedToken =
        m_holographicSpace->CameraAdded +=
            ref new Windows::Foundation::TypedEventHandler<HolographicSpace^, HolographicSpaceCameraAddedEventArgs^>(
                std::bind(&MRAppServiceDemoMain::OnCameraAdded, this, _1, _2)
                );
...
void MRAppServiceDemoMain::UnregisterHolographicEventHandlers()
{
...
MRAppServiceDemoMain::~MRAppServiceDemoMain()
{
...
HolographicFrame^ MRAppServiceDemoMain::Update()
{
...
bool MRAppServiceDemoMain::Render(Windows::Graphics::Holographic::HolographicFrame^ holographicFrame)
{
...
void MRAppServiceDemoMain::SaveAppState()
{
    //
...
void MRAppServiceDemoMain::LoadAppState()
{
    //
...
void MRAppServiceDemoMain::OnDeviceLost()
{
#ifdef DRAW_SAMPLE_CONTENT
...
void MRAppServiceDemoMain::OnDeviceRestored()
{
#ifdef DRAW_SAMPLE_CONTENT
...
void MRAppServiceDemoMain::OnLocatabilityChanged(SpatialLocator^ sender, Object^ args)
{
...
void MRAppServiceDemoMain::OnCameraAdded(
...
void MRAppServiceDemoMain::OnCameraRemoved(
    HolographicSpace^ sender,
