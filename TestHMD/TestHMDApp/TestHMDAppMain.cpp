...
TestHMDAppMain::TestHMDAppMain(const std::shared_ptr<DX::DeviceResources>& deviceResources) :
    m_deviceResources(deviceResources)
{
    ...
    m_gamepadAddedEventToken = Gamepad::GamepadAdded +=
        ref new EventHandler<Gamepad^>(
            bind(&TestHMDAppMain::OnGamepadAdded, this, _1, _2)
            );

    m_gamepadRemovedEventToken = Gamepad::GamepadRemoved +=
        ref new EventHandler<Gamepad^>(
            bind(&TestHMDAppMain::OnGamepadRemoved, this, _1, _2)
            );
...
void TestHMDAppMain::SetHolographicSpace(HolographicSpace^ holographicSpace)
{
    ...
    m_holographicDisplayIsAvailableChangedEventToken = HolographicSpace::IsAvailableChanged +=
        ref new EventHandler<Object^>(
            bind(&TestHMDAppMain::OnHolographicDisplayIsAvailableChanged, this, _1, _2)
            );
    ...
    m_cameraAddedToken =
        m_holographicSpace->CameraAdded +=
            ref new TypedEventHandler<HolographicSpace^, HolographicSpaceCameraAddedEventArgs^>(
                std::bind(&TestHMDAppMain::OnCameraAdded, this, _1, _2)
                );
    ...
    m_cameraRemovedToken =
        m_holographicSpace->CameraRemoved +=
            ref new TypedEventHandler<HolographicSpace^, HolographicSpaceCameraRemovedEventArgs^>(
                std::bind(&TestHMDAppMain::OnCameraRemoved, this, _1, _2)
                );
...
void TestHMDAppMain::UnregisterHolographicEventHandlers()
{
...
HolographicFrame^ TestHMDAppMain::Update()
{
...
bool TestHMDAppMain::Render(HolographicFrame^ holographicFrame)
{
...
void TestHMDAppMain::SaveAppState()
{
    //
...
void TestHMDAppMain::LoadAppState()
{
    //
...
void TestHMDAppMain::OnPointerPressed()
{
    m_pointerPressed = true;
}
...
void TestHMDAppMain::OnDeviceLost()
{
#ifdef DRAW_SAMPLE_CONTENT
...
void TestHMDAppMain::OnDeviceRestored()
{
#ifdef DRAW_SAMPLE_CONTENT
...
void TestHMDAppMain::OnLocatabilityChanged(SpatialLocator^ sender, Object^ args)
{
...
void TestHMDAppMain::OnCameraAdded(
...
void TestHMDAppMain::OnCameraRemoved(
    HolographicSpace^ sender,
...
void TestHMDAppMain::OnGamepadAdded(Object^, Gamepad^ args)
{
...
void TestHMDAppMain::OnGamepadRemoved(Object^, Gamepad^ args)
{
...
void TestHMDAppMain::OnHolographicDisplayIsAvailableChanged(Object^, Object^)
{
        ...
        if (spatialLocator != nullptr)
        {
            ...
            m_locatabilityChangedToken =
                ...
                ref new TypedEventHandler<SpatialLocator^, Object^>(
                    std::bind(&TestHMDAppMain::OnLocatabilityChanged, this, _1, _2)
                    );
