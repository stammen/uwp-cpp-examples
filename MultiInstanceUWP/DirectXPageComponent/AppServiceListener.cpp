...
AppServiceListener::AppServiceListener(Platform::String^ listenerId)
...
AppServiceListener::~AppServiceListener()
{
}


Concurrency::task<AppServiceConnectionStatus> AppServiceListener::ConnectToAppService(Platform::String^ serviceName, Platform::String^ packageFamilyName)
{
    m_appService = ref new AppServiceConnection();
    m_appService->RequestReceived += ref new TypedEventHandler<AppServiceConnection^, AppServiceRequestReceivedEventArgs^>(this, &AppServiceListener::OnRequestReceived);
...
Concurrency::task<Windows::ApplicationModel::AppService::AppServiceResponse^> AppServiceListener::RegisterListener(IAppServiceListenerDelegate^ delegate)
{
...
Concurrency::task<Windows::ApplicationModel::AppService::AppServiceResponse^> AppServiceListener::SendAppServiceMessage(Platform::String^ listenerId, ValueSet^ message)
{
...
void AppServiceListener::OnRequestReceived(AppServiceConnection^ sender, AppServiceRequestReceivedEventArgs^ args)
{
