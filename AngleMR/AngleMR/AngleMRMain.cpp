...
AngleMRMain::AngleMRMain(const std::shared_ptr<DX::DeviceResources>& deviceResources) :
...
void AngleMRMain::SetHolographicSpace(HolographicSpace^ holographicSpace)
{
    ...
    m_locatabilityChangedToken =
        m_locator->LocatabilityChanged +=
            ref new Windows::Foundation::TypedEventHandler<SpatialLocator^, Object^>(
                std::bind(&AngleMRMain::OnLocatabilityChanged, this, _1, _2)
                );
    ...
    m_cameraAddedToken =
        m_holographicSpace->CameraAdded +=
            ref new Windows::Foundation::TypedEventHandler<HolographicSpace^, HolographicSpaceCameraAddedEventArgs^>(
                std::bind(&AngleMRMain::OnCameraAdded, this, _1, _2)
                );
    ...
    m_cameraRemovedToken =
        m_holographicSpace->CameraRemoved +=
            ref new Windows::Foundation::TypedEventHandler<HolographicSpace^, HolographicSpaceCameraRemovedEventArgs^>(
                std::bind(&AngleMRMain::OnCameraRemoved, this, _1, _2)
                );
...
HolographicFrame^ AngleMRMain::Update()
{
...
bool AngleMRMain::Render(Windows::Graphics::Holographic::HolographicFrame^ holographicFrame)
{
        ...
        [this, holographicFrame](std::map<UINT32, std::unique_ptr<DX::CameraResources>>& cameraResourceMap)
    {
        ...
        for (auto cameraPose : prediction->CameraPoses)
        {
            ...
            if (cameraActive)
            {
                ...
                m_angleResources->Submit(context, pCameraResources->GetBackBufferTexture2D(), DX::ANGLE::EyeIndex::Eye_Left, size.Width, size.Height);
                m_renderer->Render(EVREye::Eye_Right);
                m_angleResources->Submit(context, pCameraResources->GetBackBufferTexture2D(), DX::ANGLE::EyeIndex::Eye_Right, size.Width, size.Height);
...
void AngleMRMain::OnDeviceRestored()
{
#ifdef DRAW_SAMPLE_CONTENT
...
void AngleMRMain::OnLocatabilityChanged(SpatialLocator^ sender, Object^ args)
{
...
void AngleMRMain::OnCameraAdded(
...
void AngleMRMain::OnCameraRemoved(
    HolographicSpace^ sender,
