...
void SpinningCubeRenderer::SetColor(float4 color)
{
    XMStoreFloat4(&m_color, { color.x, color.y, color.z, color.w });
}
...
void SpinningCubeRenderer::Update(const DX::StepTimer& timer)
{
    ...
    m_modelConstantBufferData.color = m_color;
...
{
    XMStoreFloat4(&m_color, { 1.0, 0.0, 0.0, 1.0 });
